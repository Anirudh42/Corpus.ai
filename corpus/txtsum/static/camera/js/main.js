...
function takeSnapshot() {
    ...
    //     var myFile = new File([blob], "img1");
    //     // var myFile = blobToFile(blob, "my-image");
    //     console.log(myFile.name);
    //     formdata = new FormData();
    //     formdata.append("csrfmiddlewaretoken", $('[name="csrfmiddlewaretoken"]').val());
    //     formdata.append("image", myFile.name);
    //     // myFile = getBase64Image(myFile)
    //     // var data_single = {
    //     //     'csrfmiddlewaretoken': $('[name="csrfmiddlewaretoken"]').val(),
    //     //     'myFile': formdata
    //     //             }
    //     // data_single['myFile']=JSON.stringify(data_single['myFile'])
    //     $.ajax({
    //         url: "/waste/predict/",
    //         type: "POST",
    //         processData: false,
